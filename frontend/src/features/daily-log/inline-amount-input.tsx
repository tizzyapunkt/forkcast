  ...
  return (
    <span className="flex items-center gap-1 text-xs">
      <input
        ...
        className="w-16 rounded-md border border-transparent bg-transparent px-1 py-0.5 text-right text-base text-muted-foreground hover:border-border focus:border-ring focus:text-foreground focus:outline-none sm:text-sm"
      />
