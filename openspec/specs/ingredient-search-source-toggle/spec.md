...
Allow the user to choose which ingredient sources are included in search results. A toggle in the search panel enables or disables Open Food Facts results alongside the default BLS source, with the preference persisted across sessions.
